...
<div class="page-header">
  <div class="row">
    <div class="col-md-8">
      <h1>生产领料出库单管理<small>Produce InventoryOut Management</small></h1>
    </div>
    <div class="col-md-4" id="search">
	<s:form action="produceAction_search" class="form form-inline" role="form" method="post">
...
<div class="panel panel-info">
	<div class="panel-heading">生产领料出库单
		<div class="pull-right">
			<s:a action="produceAction_addUI" cssClass="btn btn-default btn-sm" role="button">添加</s:a>
		</div>
	</div>
<table id="tbl" class="table table-hover table-bordered table-striped table-responsive">
  ...
  <s:iterator value="recordList">
    <tr>
      ...
      <td>${ number }</td>
      <td>${ totalPrice }</td>
      <td><s:a id="delete" action="produceAction_delete?itemId=%{inventoryOutItem.id}" onClick="return confirm('确定要删除吗?')" title="删除"><i class="fa fa-lg fa-trash-o"></i></s:a>
      	  <s:a id="edit" action="produceAction_editUI?itemId=%{inventoryOutItem.id}" title="修改"><i class="fa fa-pencil-square-o fa-lg"></i></s:a>
      	  <s:a id="audit" action="produceAction_audit?itemId=%{inventoryOutItem.id}" name="audit" onClick="return confirm('确定要审核?')" title="未审核"><i class="fa fa-lg fa-check-square-o"></i></s:a></td>
    </tr>
    </s:iterator>
  </tbody>
</table>
