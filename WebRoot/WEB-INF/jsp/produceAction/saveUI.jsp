...
<script>
function addRow(id){
	var newRow=$('#test>tbody>tr:last').attr('id');
	newRow++;
...
<s:form action="produceAction_%{itemId==null?'add':'edit'}" cssClass="form form-horizontal" role="form" method="post">
    ...
    <table class="table table-hover table-bordered table-striped table-responsive" id="tab">
      ...
      <s:iterator value="inventoryOutMaterialsList">
        <tr>
          ...
          <td>
          <s:select id="input" value="%{unit.id}" name="unitId" cssClass="form-control input-sm" list="#unitList" listKey="id" listValue="name" headerKey="" headerValue="请选择单位" />
		  </td>
          <td>
