...
<s:form action="otherInAction_%{itemId==null?'add':'edit'}" cssClass="form form-horizontal" role="form" method="post">
  ...
  <div id="top">
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group">
          <label for="input" class="col-md-4 control-label">收料仓库:</label>
          <div class="col-md-8">
