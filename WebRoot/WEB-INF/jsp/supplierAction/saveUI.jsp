...
<div id="top">
  <s:form action="supplierAction_%{id==null?'add':'edit'}" role="form" cssClass="form-horizontal" method="post" id="form">
    <s:hidden name="id"></s:hidden>
    <div class="form-group">
      <label for="name" class="col-md-2 control-label">供应商名称</label>
      <div class="col-md-10">
