...
<s:form action="productAction_%{itemId==null?'add':'edit'}" cssClass="form form-horizontal" role="form" method="post">
  <s:hidden name="itemId"></s:hidden>
  <div id="top">
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          <label for="input" class="col-md-4 control-label">交货部门:</label>
          <div class="col-md-8">
