...
<s:form action="salesAction_%{itemId==null?'add':'edit'}" cssClass="form form-horizontal" role="form" method="post">
  <s:hidden name="itemId"></s:hidden>
  <div id="top">
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
           <label for="input" class="col-md-4 control-label">购货单位:</label>
          <div class="col-md-8">
			<s:select id="input" cssClass="form-control input-sm" name="consumerId" list="#consumerList" 
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group">
          <label for="input" class="col-md-4 control-label">发货仓库:</label>
          <div class="col-md-8">
