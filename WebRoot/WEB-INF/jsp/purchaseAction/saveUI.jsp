...
<s:form action="purchaseAction_%{itemId==null?'add':'edit'}" cssClass="form form-horizontal" role="form" method="post">
  <s:hidden name="itemId"></s:hidden>
  <div id="top">
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
           <label for="input" class="col-md-4 control-label">供应商:</label>
          <div class="col-md-8">
			<s:select id="input" cssClass="form-control input-sm" name="supplierId" list="#supplierList" 
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          <label for="itemId" class="col-md-4 control-label">单据编号:</label>
          <div class="col-md-8">
            <s:textfield cssClass="form-control input-sm" name="itemId" id="itemId" disabled="true"></s:textfield>
          </div>
        </div>
      </div>
      <div class="col-md-4"></div>
      <div class="col-md-4">
        <div class="form-group">
          <label for="input" class="col-md-4 control-label">收货仓库:</label>
          <div class="col-md-8">
  ...
  <div id="table">
    <table class="table table-hover table-bordered table-striped table-responsive" id="tab">
      ...
      <s:iterator value="inventoryInMaterialsList">
        <tr>
          <td> 
