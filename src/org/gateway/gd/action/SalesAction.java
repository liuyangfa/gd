...
@Controller
@Scope("prototype")
public class SalesAction extends BaseAction<Object> {
	...
	private Long[] materialsId; // 物料编码
	private Long[] unitId; // 单位编码
	...
	public String search() throws Exception {
		...
		if (condition.equals("consumerId") && !content.equals("")) {
			queryHelper.addWhereCondition(
					"iom.inventoryOutItem.consumer.name like ?",
					"%" + content.trim() + "%");
			PageBean pageBean = inventoryOutMaterialsService.getPageBean(
					pageNum, pageSize, queryHelper);
			ActionContext.getContext().getValueStack().push(pageBean);
	...
	public String addUI() throws Exception {
		...
		ActionContext.getContext().put("consumerList", consumerList);
	...
	public String add() throws Exception {
		...
		inventoryOutItem.setOutType(InventoryOutItem.TYPE2);
		...
		inventoryOutItem.setConsumer(consumerService.getById(consumerId));
	...
	public String editUI() throws Exception {
		...
		if (inventoryOutItem.getConsumer() != null) {
			consumerId = inventoryOutItem.getConsumer().getId();
		}
