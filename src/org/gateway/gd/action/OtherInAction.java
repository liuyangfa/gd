...
@Controller
@Scope("prototype")
public class OtherInAction extends BaseAction<Object> {

	private Long itemId; // 其他入库单编号
	...
	private String description; // 其它入库单说明
